...
/**
 * Tooltip root provider (shadcn-style).
 *
 * Place this once near the app root so tooltips render consistently in portals.
 *
 * @param props - Radix Tooltip provider props.
 * @returns Tooltip provider wrapper.
 */
...
/**
 * Tooltip root (shadcn-style).
 *
 * @param props - Radix Tooltip root props.
 * @returns Tooltip root.
 */
...
/**
 * Tooltip trigger (shadcn-style).
 *
 * @param props - Radix Tooltip trigger props.
 * @returns Tooltip trigger.
 */
...
/**
 * Tooltip content (shadcn-style).
 *
 * @param props - Radix Tooltip content props.
 * @returns Tooltip content portal.
 */
