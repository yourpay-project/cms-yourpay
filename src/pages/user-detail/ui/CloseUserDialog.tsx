...
interface CloseUserDialogProps {
  open: boolean;
...
/**
 * Modal form for terminating a customer account.
 *
 * @param props - Component props.
 * @returns Termination confirmation/form modal.
 */
const CloseUserDialog: FC<CloseUserDialogProps> = ({ open, onOpenChange, customerId }) => {
...
export default CloseUserDialog;
