...
import { useCustomerWalletsQuery, type CustomerWalletItem } from "../model";

interface ViewWalletsDialogProps {
  open: boolean;
 ...
 * @returns Wallet list modal content.
 */
const ViewWalletsDialog: FC<ViewWalletsDialogProps> = ({ open, onOpenChange, customerId }) => {
...
export default ViewWalletsDialog;
