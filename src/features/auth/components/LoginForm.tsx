...
import { getGoogleAuthUrl } from "@/features/auth/services/auth-service";
import { DEMO_CREDENTIALS } from "@/features/auth/constants/demo-auth";
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-muted p-3">
            <p className="text-center text-xs leading-relaxed text-foreground break-words">
