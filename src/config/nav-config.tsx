...
/**
 * Nav item for sidebar. Mirrors Laravel Filament: navigationGroup, navigationLabel, permission (view_any_<identifier>).
 * permission: optional; if omitted, item is visible to all authenticated users.
 */
export interface NavItemConfig {
  to: string;
  label: string;
  icon?: ReactNode;
  /** Permission required to see this item (e.g. view_any_identity_access_resource). */
  permission?: string;
}

/**
 * Grouped nav config. Mirrors Laravel navigation groups (User & Access Management, KYC & Verification, etc.).
 */
